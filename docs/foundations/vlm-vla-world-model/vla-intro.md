...
- [2. 一条从语言到动作的线](2.vla_landscape.md)
- [3. RT-1：为什么是 3 Hz，为什么是 256 个 bin](3.rt1_architecture.md)
- [4. RT-2：一个机械臂怎么学会了"把苹果放到数字 3 上"](4.rt2_semantic_transfer.md)
- [5. Open X：数据与跨机体迁移](5.openx_data_scaling.md)
- [6. OpenVLA：复现与关键取舍](6.openvla_engineering.md)
- [7. ACT：当误差以 $O(L^T)$ 增长时，你该怎么办](7.act_action_chunking.md)
- [8. Diffusion Policy：动作建模](8.diffusion_policy.md)
- [9. pi0：架构与训练配方](9.pi0_foundation_model.md)
- [10. pi0.5：开放世界与分层执行](10.pi05_open_world.md)
- [11. RTC：实时执行与系统交付](11.rtc_realtime_execution.md)
- [12. pi0.6：在线闭环与优势策略](12.pi06_online_learning.md)
- [13. pi0.7：可引导与组合泛化（终篇）](13.pi07_steerable_emergence.md)
