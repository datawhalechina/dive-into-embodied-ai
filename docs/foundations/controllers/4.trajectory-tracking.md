...
$$
\begin{equation}\label{eq:controllers-trajectory-feedback}
...
$$
\begin{equation}\label{eq:controllers-feedforward-feedback}
u = u_{ff} + u_{fb}
\end{equation}
$$
...
$$
\begin{equation}\label{eq:controllers-inverse-dynamics-feedforward}
...
$$
\begin{equation}\label{eq:controllers-task-space-force}
...
$$
\begin{equation}\label{eq:controllers-jacobian-transpose}
\tau = J(q)^\top F
\end{equation}
$$
