...
$$
\begin{equation}\label{eq:controllers-continuous-pid}
...
$$
\begin{equation}\label{eq:controllers-discrete-integral}
I_k = I_{k-1} + e_k \Delta t
\end{equation}
$$

$$
\begin{equation}\label{eq:controllers-discrete-derivative}
D_k = \frac{e_k - e_{k-1}}{\Delta t}
\end{equation}
$$

$$
\begin{equation}\label{eq:controllers-discrete-pid}
...
$$
\begin{equation}\label{eq:controllers-derivative-difference}
D_k = \frac{e_k - e_{k-1}}{\Delta t}
\end{equation}
$$
...
$$
\begin{equation}\label{eq:controllers-derivative-on-measurement}
