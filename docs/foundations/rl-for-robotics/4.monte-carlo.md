...
<Figure src={require('./figs/simple_maze.webp').default} caption="2x2 网格示例" width={200} />
...
```python title="代码 1: 使用蒙特卡洛方法估计圆周率"
import random
...
<Figure src={require('./figs/fvmc_pseu.webp').default} caption="首次访问蒙特卡洛算法伪代码" width={600} />
...
```python title="代码 2: 首次访问蒙特卡洛方法估计状态价值函数"
import numpy as np
...
```python title="代码 4: 每次访问蒙特卡洛方法估计状态价值函数"
import numpy as np
from collections import defaultdict
...
```python title="代码 6: 蒙特卡洛方法估计动作价值函数"
import numpy as np
from collections import defaultdict
...
```python title="代码 8: 使用蒙特卡洛方法估计 3x3 网格状态价值函数"
import random
from collections import defaultdict
import numpy as np
import pandas as pd
...
<Figure src={require('./figs/maze_33_mc_state_values.webp').default} caption="3x3 网格中的状态价值热力图" width={400} />
...
```python title="代码 9: 使用蒙特卡洛方法估计 3x3 网格动作价值函数"
import random
from collections import defaultdict
import numpy as np
import matplotlib.pyplot as plt
...
<Figure src={require('./figs/maze_33_mc_action_values.webp').default} caption="3x3 网格中的动作价值热力图" width={800} />
...
<Figure src={require('./figs/mc_control_pseu.webp').default} caption="蒙特卡洛控制算法伪代码" width={600} />

在 $3 \times 3$ 网格的示例中，可以用蒙特卡洛控制方法来学习一个更优的策略，代码实现如代码 10 所示。

```python title="代码 10: 使用蒙特卡洛控制方法学习 3x3 网格最优策略"
import random
from collections import defaultdict
import numpy as np
import matplotlib.pyplot as plt
...
<Figure src={require('./figs/maze_33_mc_control_policy.webp').default} caption="3x3 网格中的蒙特卡洛控制最优策略与路径" width={800} />
