...
<Figure src={require('./figs/openvla_teaser.webp').default} caption="OpenVLA 总览：从 OpenX 预训练、VLA 微调到下游适配与部署的完整工程链路。" width={820} />
...
<Figure src={require('./figs/openvla_model.webp').default} caption="OpenVLA 架构：SigLIP 与 DinoV2 双视觉特征融合，经两层 MLP 投影后接入 Llama 2 7B 动作解码。" width={820} />
...
<Figure src={require('./figs/bridge_tasks_vertical.webp').default} caption="BridgeData V2 评测任务构成：这组图更适合用来理解不同泛化维度的划分，而不是直接拿来比较分数高低。" width={520} />
...
<Figure src={require('./figs/bridge_results.webp').default} caption="BridgeData V2 结果：OpenVLA 在总体平均上显著领先，但在 semantic generalization 子类上并不是绝对最强。" width={820} />
...
<Figure src={require('./figs/rt1_results.webp').default} caption="Google robot 结果：OpenVLA 与 RT-2-X 总体处于同一量级，且二者都明显高于 RT-1-X 和 Octo。" width={520} />
...
<Figure src={require('./figs/franka_tabletop_tasks.webp').default} caption="Franka-Tabletop 适配任务：前三个任务偏窄任务与精细操控，后三个任务开始明显强调多对象与语言 grounding。" width={520} />
...
<Figure src={require('./figs/finetune_results.webp').default} caption="下游适配结果：OpenVLA 在多指令、多物体、语言 grounding 任务上的平均表现更稳，而 Diffusion Policy 在部分窄任务和精细轨迹任务上仍然很强。" width={850} />
...
<Figure src={require('./figs/inference_speed.webp').default} caption="OpenVLA 推理吞吐对比：量化方式会直接影响控制频率，从而改变非阻塞控制下的系统动力学。" width={620} />
