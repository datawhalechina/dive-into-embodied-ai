...
<SourceCodeCard
  title="完整源代码"
  description="点击展开查看 Pusher-v5 的 DDPG 训练脚本"
  language="python"
  filename="train_ddpg_pusher_v5.py"
>
  {trainSource}
</SourceCodeCard>
...
<Figure src={require('./figs/pusher-baseline.gif').default} caption="DDPG Pusher-v5 baseline 效果" />
