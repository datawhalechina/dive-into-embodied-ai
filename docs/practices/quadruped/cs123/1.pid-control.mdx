...
<Figure
  src={require('./figs/open-loop-control.webp').default}
  caption="开环控制：指令单向下发，执行端状态不回传"
  width={800}
/>
...
<Figure
  src={require('./figs/closed-loop-control.webp').default}
  caption="闭环控制：传感器把实测状态回传，控制器据此修正"
  width={800}
/>
...
<Figure
  src={require('./figs/pd-kd-sweep.webp').default}
  caption="实验 1：固定 Kp=40，只改变 Kd 时的单摆响应曲线"
  width={800}
/>
...
<Figure
  src={require('./figs/pd-disturbance-error.webp').default}
  caption="实验 2：3 秒后加入恒定外扰，P 和 PD 都会留下稳态误差"
  width={800}
/>
