...
const sidebars: SidebarsConfig = {
  introductionSidebar: [
    'introduction/intro',
    'introduction/what-is-embodied-ai',
    ...
    'introduction/careers',
    {
      type: 'category',
      label: '领域资源',
      link: { type: 'doc', id: 'introduction/resources/index' },
      collapsed: false,
      items: [
        'introduction/resources/papers',
        'introduction/resources/datasets',
        'introduction/resources/open-source',
  ...
  foundationsOverviewSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'link', label: 'ODO、时间戳与状态估计', href: '/docs/foundations/perception/odo-timestamps-state-estimation' },
        { type: 'link', label: '相机、LiDAR 与 IMU 外参与投影', href: '/docs/foundations/perception/sensor-projection' },
        { type: 'link', label: '在线标定、评测与故障诊断', href: '/docs/foundations/perception/online-calibration-diagnosis' },
      ],
    },
    {
      type: 'category',
  ...
  practicesCs123CourseSidebar: [
    { type: 'link', label: '← 项目实战', href: '/docs/practices/intro' },
    {
      type: 'category',
      label: '从零到一搭建四足机器人',
