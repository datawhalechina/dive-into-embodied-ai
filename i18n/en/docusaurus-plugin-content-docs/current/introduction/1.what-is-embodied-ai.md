...
These differences explain why large models improve quickly at conversation and writing, while getting robots to fold laundry or do housework reliably remains hard. [Chapter 5](./5.challenges.md) discusses these problems one by one.
...
- [Foundations](/docs/foundations/intro): continue with modules on decision-making, control, perception, and engineering.
