...
A useful starting point is four common skill categories: **grasping, manipulation, locomotion, and navigation**. Grasping and manipulation change object states; locomotion and navigation move the robot itself. The [learning map](/learning-map#robot-interaction) provides a step-by-step demo for each skill.
...
- [Learning map](/learning-map#directions): choose a project direction in manipulation, legged locomotion, or navigation and mobile manipulation.
