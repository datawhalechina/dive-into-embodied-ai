...
Continue with [6. Technology stack](./6.tech-stack.md) to follow learning modules into the courses. [7. Career roles](./7.careers.md) introduces responsibilities and interview preparation. You can also choose according to your goal:

- Learn specific principles: go to the [foundations](/docs/foundations/intro).
- Build a complete system or test a method: choose a project organized into chapters or a standalone experiment in [projects](/docs/practices/intro).
