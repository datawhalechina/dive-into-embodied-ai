...
Simulation makes training safer and cheaper, and it allows parallel runs and repeatable evaluation. The cost is a gap between simulation and reality, which [Chapter 5](./5.challenges.md#sim-to-real) discusses.
...
- [5. Key challenges](./5.challenges.md): the problems robots still face in real-world applications.
