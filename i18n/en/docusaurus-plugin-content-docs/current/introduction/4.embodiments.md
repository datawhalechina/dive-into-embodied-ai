...
With the four skills from [Chapter 3](./3.tasks-and-skills.md) in mind, explore these five common types of physical platform, followed by simulated bodies used in research. The [learning map](/learning-map#embodied-platforms) shows motion demos for each type.
