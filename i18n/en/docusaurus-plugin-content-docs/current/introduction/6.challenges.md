...
The previous chapters covered what embodied AI does and how systems are organized. This chapter discusses problems that are not yet well solved, which are also the starting point of much research. Knowing these challenges helps you judge what a result actually solves and where it applies.

**This chapter answers**

- Why is robot data so hard to obtain?
- Why do policies learned in simulation fail on real robots?
- How can you tell whether a method truly generalizes or only reproduces its training tasks?

## 6.1 Data: scarce, expensive, and hard to reuse \{#data}
...
## 6.2 The sim-to-real gap \{#sim-to-real}
...
## 6.3 Generalization \{#generalization}
...
## 6.4 Long-horizon tasks and compounding errors \{#long-horizon}
...
## 6.5 Real-time execution and compute \{#real-time}
...
## 6.6 Safety and reliability \{#safety}
...
## 6.8 The challenges are connected \{#connected}
...
- Choose your first learning path: return to the [learning map](/learning-map#first-steps).
