...
# Private agent tooling and intermediate renders are not published site assets.
SKIP_DIRS = {".git", ".agents", "node_modules", "build", ".docusaurus", ".venv", "portfolio", "tb", "tmp", "__pycache__"}
MAX_BYTES = 512_000
