...
def make_microduck_velocity_env_cfg(
    ...
    # Defensive ROCm guard: a valid flat-ground trajectory cannot put the
    # trunk below the plane.  If a future backend revision regresses dynamic
    # contact detection, terminate instead of rewarding upright free-fall.
    cfg.terminations["below_ground"] = TerminationTermCfg(
