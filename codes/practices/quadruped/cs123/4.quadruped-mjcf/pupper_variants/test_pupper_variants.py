"""Pupper 变体数值检查：验证模型缩放、站姿和 PD 扫描。"""
...
from utils import PDGains
from run_pupper_variants import (
    KD_GRID,
    KP_GRID,
    SKELETON_PATH,
    VARIANTS,
...
def test_skeleton_include_and_mass_consistency() -> tuple[int, float]:
    ...
    for spec in VARIANTS.values():
        ...
        assert '<include file="../../../pupper_variants/skeleton.xml"/>' in variant_source
