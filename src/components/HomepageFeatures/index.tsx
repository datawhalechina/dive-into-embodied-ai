...
import {ArrowRight, BookOpen, FlaskConical, Telescope} from 'lucide-react';
...
const tracks = [
  ...
  {title: translate({message: "项目实战"}), lead: translate({message: "动手实验，让算法跑起来。"}), description: translate({message: "跟随完整项目逐章实践，或选择一个 Demo，在仿真和真机中验证方法。"}), to: '/docs/practices/intro', label: translate({message: "选择实践项目"}), icon: FlaskConical, topics: [translate({message: "四足机器人"}), 'LeRobot', translate({message: "MicroDuck 小黄鸭"})]},
];
    ...
    <section className={styles.features} aria-labelledby="learning-title">
      <div className="home-container">
        <div className="home-section-heading">
          ...
          <p>{translate({message: "先看全局，再理解原理、动手做项目。"})}</p>
        </div>
